...
Comment.create(post: first_post, author: second_user, text: 'I am fine.')
Comment.create(post: first_post, author: second_user, text: 'Great post!')
Comment.create(post: first_post, author: second_user, text: 'I like your post!')
